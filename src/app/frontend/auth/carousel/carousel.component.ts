...
@Component({
    ...
    <div (mouseenter)="pause()" (mouseleave)="play()" class="carousel slide">
      <ol class="carousel-indicators" style="bottom: 170px;" [hidden]="slides.length <= 1">
         <li class="mark" *ngFor="let slidez of slides" [class.active]="slidez.active === true" (click)="select(slidez)"></li>
      </ol>
      <div class="carousel-inner"><ng-content></ng-content></div>
    </div>
  `,
    styles: ['.mark{width: 10px; height: 10px;border-radius: 50%;}']
})

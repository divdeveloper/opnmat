...
@Component({
  selector: 'opn-create-activity',
  templateUrl: './create-activiti.component.html',
  styleUrls: ['./create-activiti.component.scss'],
  providers: [ActivitiesService, DatePipe],
  entryComponents: [UiSelectComponent],
})
export class CreateActivitiComponent implements OnInit {
  private step: any = 1;
  private dateOptionsStart: Object;
  ...
  @ViewChild('special', {
    read: ElementRef,
  }) specialRef: ElementRef;
  @ViewChild('step1Btn', {
    read: ElementRef,
  }) step1BtnRef: ElementRef;
  ...
  onChangeTypeEvent(event, type) {
    this.classRef.nativeElement.classList.remove('active');
    this.eventRef.nativeElement.classList.remove('active');
    this.specialRef.nativeElement.classList.remove('active');
    event.target.classList.add('active');
    this.step1BtnRef.nativeElement.classList.add('accept');
